...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: 'secureTextPopup.html',
      template: path.join(src_dir,'browser_action','secureTextPopup.html'),
      inject: false,
    }),
    new HtmlWebpackPlugin({
      filename: 'secureTextPopup.css',
      template: path.join(src_dir,'browser_action','secureTextPopup.css'),
      inject: false,
    }),
    new HtmlWebpackPlugin({
